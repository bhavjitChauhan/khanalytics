<template>
    <Container :height="height" class="relative overflow-auto">
        <table v-if="peaks" class="table w-full table-compact">
            <thead>
                <tr>
                    ...
                    <th><a href="https://en.wikipedia.org/wiki/Standard_deviation" target="_blank"><abbr
                                title="Standard Deviation">S.D.</abbr></a></th>
                </tr>
            </thead>
            <tbody>
                <tr v-for="(peak, key) in peaks" :key="key" class="text-right hover">
